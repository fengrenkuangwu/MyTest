...
public class LDAPAuthentication {
    ...
    private final String URL = "ldap://192.168.11.80:389/";
    private final String BASEDN = "dc=pekall,dc=com";  // 根据自己情况进行修改
    ...
    private void LDAP_connect() {
        ...
        String root = "cn=Manager,dc=pekall,dc=com";  //根据自己情况修改
    ...
    private  boolean addUser(String usr, String pwd) {
        ...
        try {
            ...
            ctx.createSubcontext("cn=Manager", attrsbu);
    ...
    public static void main(String[] args) {
        ...
        /*if(ldap.authenricate("No.1", "pekall1234") == true){
            System.out.println( "该用户认证成功" );
        }*/
        ldap.addUser("leaf","secret");
